...
class FLToast: NSObject {
    ...
    class func showToastAction(message : NSString) {
        self.showToast(message: message, aLocationStr: "center", aShowTime: TimeInterval(TOASTSHOWTIME))
    }
    ...
    class func showIndicatorToastAction(message : NSString) {
        self.showIndicatorToast(message: message, aLocationStr: "center", aShowTime: TimeInterval(TOASTSHOWTIME))
    }
